...
QtObject {
    ...
    readonly property string iconCheck: "check"
    readonly property string iconAdd: "add"
    readonly property string iconDelete: "delete"
    readonly property string iconTimer: "timer"
    readonly property string iconWeather: "wb_sunny"
    readonly property string iconWifi: "wifi"
    readonly property string iconBluetooth: "bluetooth"
    readonly property string iconDnd: "do_not_disturb_on"
    readonly property string iconNightLight: "nightlight"
    readonly property string iconScreenshot: "photo_camera"
    readonly property string iconClipboard: "content_copy"
    readonly property string iconTerminal: "terminal"
    readonly property string iconCode: "code_blocks"
    readonly property string iconFolder: "folder_open"
    readonly property string iconSettings: "settings"
    readonly property string iconWeb: "travel_explore"
    readonly property string iconNetwork: "swap_vert"
    readonly property string iconDisk: "hard_drive"
